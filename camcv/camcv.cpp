...
//#include "/home/pi/pierre/libfacerec-0.04/include/facerec.hpp"  <=== modify
#include "/home/pi/libface/libfacerec-0.04/include/facerec.hpp"
...
char key;
int count_screen = 0;   // counter for screen shot	
...
static void default_status(RASPIVID_STATE *state)
{
   ...
   state->timeout 			= 45000;     // capture time : here 45 s
...
////////////////////////////////
	...
	{       
		...
		if (prediction<MAX_PEOPLE)
		{
			stringstream ss;
			ss << count_screen;
			box_text = "Id="+people[prediction]+ " *" +ss.str();
		}
		else
		{
	...
	{		// int rc system = ("/home/pi/camcv/mail.sh");
			...
			else if(count_screen == 60){
				int rc = system("/home/pi/camcv/screen.sh");
				count_screen++;	
			}
			else if(count_screen >= 61){
				if(count_screen == 120){
					int rc2 = system("/home/pi/camcv/mail.sh");
					count_screen = 0;
				}
				count_screen++;
			}
...
/////////////////////////////////
	...
	// life is hard.
	people[P_ZHU] 	        = "ZHU";
	people[P_GHOSTUNT893] 	= "GHOSTUNT893";
	people[P_MONA] 		= "Mona Lisa";
	people[P_SCOTT]		= "SCOTT";
